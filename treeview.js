//---------------------------------------------------------------------------
// "OS Installation Planner" treeview.js
// Runs in Electron render process
// from https://www.npmjs.com/package/js-treeview
//---------------------------------------------------------------------------
    ...
    return (function () {
      ...
      function render(self) {
        ...
        var renderLeaf = function (item) {
          ...
          switch (item.color) {
            case 'red': text.setAttribute('class', 'tree-leaf-text-red'); break;
            case 'pink': text.setAttribute('class', 'tree-leaf-text-pink'); break;
            case 'green': text.setAttribute('class', 'tree-leaf-text-green'); break;
            case 'yellow': text.setAttribute('class', 'tree-leaf-text-yellow'); break;
            default: text.setAttribute('class', 'tree-leaf-text'); break;
          }
        ...
        //console.log("treeview render: return");
      }
